...
<html>
    ...
    <body>
        <h1 align="center">
            <font color="cyan"><b>Melmaruvathur</b></font>
        </h1>
        <h3 align="center">
            <font color="red"><b>GOKUL.M (212222230037)</b></font>
        </h3>
        <center>
...
<html>
    <head>
        <title>Hotel Sakthi Park</title>
    </head>
    <body bgcolor="silver">
        <h1 align = "center">Welcome to Hotel Sakthi Park</h1>
        <h2>

Conveniently nestled in the heart of [Melmaruvathur], [Hotel Sakthi Park] offers comfortable accommodation and modern amenities at an affordable price. Our 3-star hotel is perfect for both leisure and business travelers seeking a cozy retreat with easy access to local attractions and business hubs</h2>
<img src="park.jpeg" align="center"width="500" height="350">
<h3>Accommodation:
...
<html>
    <head>
        <title>Monalakshmi Mahal</title>
    </head>
    <body bgcolor="gold">
        <h1 align = "center">Welcome Monalakshmi Mahal</h1>
      <h2>
        Monalakshmi Mahal, also known as the Palace  is an architectural gem steeped in history, elegance, and grandeur. Located in the heart of Melmaruvathur, this majestic mahal stands as a testament to the opulence and refinement of its bygone era.
...
<img src="mona lakshmi.jpeg" aling="center" width="500" height="350">
...
<html>
    <head>
        <title>Omshakthi Temple</title>
    </head>
    <body bgcolor="red">
        <h1 align = "center">Welcome Omshakthi Temple</h1>
       <h2>
        Welcome to Om Shakthi Temple, a place of profound spirituality, architectural splendor, and cultural significance. Nestled amidst tranquil surroundings, this sacred sanctuary serves as a haven for devotees and visitors seeking solace, enlightenment, and a deeper connection to the divine.
       </h2>
       
<img src="omsakthi.jpeg" aling="center" width="500" height="350">
...
<html>
    <head>
        <title>Mazhai Malai Madha</title>
    </head>
    <body bgcolor="blue">
        <h1 align = "center">Welcome Mazhai Malai Madha</h1>
        <h2>
...
<img src="madha.jpeg" aling="center" width="500" height="350">
...
<html>
    <head>
        <title>GB Public School</title>
    </head>
    <body bgcolor="magenta">
        <h1 align = "center">Welcome GB Public School</h1>
       <h2>
...
<img src="gb.jpg" align ="center" width="500" height="350">
